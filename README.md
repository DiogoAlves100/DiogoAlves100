![Banner](LINK_DA_IMAGEM_OU_CAMINHO)
<div align="center">
...
Sou estudante de **Engenharia de Software** pela universidade UCSAL e **Técnico em Desenvolvimento de Sistemas** pelo SENAI CIMATEC. Apaixonado por programação web, desenvolvimento backend e automações, estou sempre focado em construir soluções eficientes, APIs e aprender novas tecnologias.

* 🌍 **Localização:** Salvador, BA - Brasil
* ✉️ **Contato:** [diogobandeira389@gmail.com](mailto:diogobandeira389@gmail.com)
* 🚀 **Foco Atual:** [Desenvolvimento de APIs e Web](https://github.com/DiogoAlves100)
* 🧠 **Estudando:** Arquitetura de Software, Node.js e Backend
* 👥 **Aberto a Colaborações:** Projetos Open Source e automações
* 💬 **Perfil:** Entusiasta de tecnologia focado em resolver problemas com código.
